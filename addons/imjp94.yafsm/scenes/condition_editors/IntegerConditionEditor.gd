...
func _ready():
	integer_value.connect("text_submitted",Callable(self,"_on_integer_value_text_entered"))
	integer_value.connect("focus_entered",Callable(self,"_on_integer_value_focus_entered"))
	integer_value.connect("focus_exited",Callable(self,"_on_integer_value_focus_exited"))
