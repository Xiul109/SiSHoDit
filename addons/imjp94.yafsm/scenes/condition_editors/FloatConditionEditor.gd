...
func _ready():
	float_value.connect("text_submitted",Callable(self,"_on_float_value_text_entered"))
	float_value.connect("focus_entered",Callable(self,"_on_float_value_focus_entered"))
	float_value.connect("focus_exited",Callable(self,"_on_float_value_focus_exited"))
