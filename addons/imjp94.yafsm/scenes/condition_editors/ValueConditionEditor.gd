...
func _ready():
	comparation_button.connect("pressed",Callable(self,"_on_comparation_button_pressed"))
	comparation_popup_menu.connect("id_pressed",Callable(self,"_on_comparation_popup_menu_id_pressed"))
