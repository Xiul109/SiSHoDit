...
func _ready():
	string_value.connect("text_submitted",Callable(self,"_on_string_value_text_entered"))
	string_value.connect("focus_entered",Callable(self,"_on_string_value_focus_entered"))
	string_value.connect("focus_exited",Callable(self,"_on_string_value_focus_exited"))
